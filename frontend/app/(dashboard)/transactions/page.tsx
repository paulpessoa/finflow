      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-zinc-500 dark:text-zinc-400">
            Gerencie seu histórico financeiro detalhadamente.
          </p>
        </div>
        <button
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="border-b border-zinc-200 bg-zinc-50 dark:border-zinc-800 dark:bg-zinc-900/50">
                <th className="px-6 py-4 text-sm font-medium text-zinc-700 dark:text-zinc-300">
                  Data
                </th>
                <th className="px-6 py-4 text-sm font-medium text-zinc-700 dark:text-zinc-300">
                  Descrição
                ...
                <th className="px-6 py-4 text-sm font-medium text-zinc-700 dark:text-zinc-300 text-right">
                  Valor
                </th>
                <th className="px-6 py-4 text-sm font-medium text-zinc-700 dark:text-zinc-300 text-right">
                  Ações
